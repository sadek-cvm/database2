...
class MainFrame(tk.Frame):
	...
	def initUI(self):
		...
		lbl = tk.Label(self.frameSearch, text="Emploi antérieur : ")
		lbl.place(x=10, y=40)

		self.searchJob = tk.Entry(self.frameSearch, width=30)
		self.searchJob.place(x=150, y=40)
	...
	def processSearch(self):
		self.deletePreviousSearch()
		results = self.app.search(self.searchAgeMin.get(), self.searchJob.get(), 10)
		y = 120
